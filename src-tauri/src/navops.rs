...
#[tauri::command]
pub async fn disablenav(tabid:String,dir:bool, state: State<'_, AppStateStore>) -> Result<(),()>{ 
...
#[tauri::command]
pub async fn navbrowsetimeline(tabid:String,dir:bool, state: State<'_, AppStateStore>) -> 
