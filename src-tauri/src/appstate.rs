...
pub struct AppStateStore {
    ...
    pub messagetothread:Arc<RwLock<String>>,
    pub messagetofilltrie:Arc<RwLock<String>>,
    recents:Vec<String>,
...
impl AppStateStore {
    pub fn new(expiration: u64) -> Self {
        ...
        Self {
            ...
            messagetothread:Arc::new(RwLock::new(String::new())),
            messagetofilltrie:Arc::new(RwLock::new(String::new())),
            recents:Vec::new(),
